                    ...
                    <div class="dropdown-menu dicustom-checkbox">
                        ...
                        <?php foreach ($cities as $city) : ?>
                            <label class="dropdown-item">
                                <input type="checkbox" name="ut_city[]" value="<?php echo esc_attr($city->name); ?>">  
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dicustom-checkbox">
                        ...
                        <?php foreach ($site_dstricts as $site_dstrict) : ?>
                            <label class="dropdown-item">
                                <input type="checkbox" name="ut_site_dstrict[]" value="<?php echo esc_attr($site_dstrict->name); ?>">  
                                <div class="dicustom-checkbox__label">
                ...
                <div class="base-range-input__wrap">
                    ...
                    <div class="base-range-input__label-wrap">
                        <label class="base-range-input__label">
                            <input name="price_from" placeholder="От" class="base-range-input__control" value="">
                        </label>
                    </div>
                    ...
                    <div class="base-range-input__label-wrap">
                        <div class="base-range-input__label">
                            <input name="price_to" placeholder="" class="base-range-input__control" value="">
                        </div>
                    </div>
    ...
    <div class="open_popup_content">
        ...
        <div class="popup_filter">
            <div class="filter_row">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dicustom-checkbox">
                            ...
                            <?php foreach ($countries as $country) : ?>
                                <label class="dropdown-item">
                                    <input type="checkbox" name="ut_country[]" value="<?php echo esc_attr($country->name); ?>">  
                                    <div class="dicustom-checkbox__label">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dicustom-checkbox">
                            ...
                            <?php foreach ($districts as $district) : ?>
                                <label class="dropdown-item">
                                    <input type="checkbox" name="ut_district[]" value="<?php echo esc_attr($district->name); ?>">  
                                    <div class="dicustom-checkbox__label">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dicustom-checkbox">
                            ...
                            <?php foreach ($departments as $department) : ?>
                                <label class="dropdown-item">
                                    <input type="checkbox" name="ut_department[]" value="<?php echo esc_attr($department->name); ?>">  
                                    <div class="dicustom-checkbox__label">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dicustom-checkbox">
                            ...
                            <?php foreach ($highways as $highway) : ?>
                                <label class="dropdown-item">
                                    <input type="checkbox" name="ut_highway[]" value="<?php echo esc_attr($highway->name); ?>">  
                                    <div class="dicustom-checkbox__label">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dicustom-checkbox">
                        ...
                        <?php for ($i = 1; $i <= 15; $i++) : ?>
                            <label class="dropdown-item">
                                <input type="checkbox" name="ut_bedrooms[]" value="<?php echo $i; ?>">  
                                <div class="dicustom-checkbox__label">
                                    <?php echo $i; ?>
                                </div>
                            </label>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dicustom-checkbox">
                        ...
                        <?php for ($i = 1; $i <= 20; $i++) : ?>
                            <label class="dropdown-item">
                                <input type="checkbox" name="ut_rooms[]" value="<?php echo $i; ?>">  
                                <div class="dicustom-checkbox__label">
                                    <?php echo $i; ?>
                                </div>
                            </label>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dicustom-checkbox">
                        ...
                        <?php for ($i = 1; $i <= 20; $i++) : ?>
                            <label class="dropdown-item">
                                <input type="checkbox" name="ut_bathrooms[]" value="<?php echo $i; ?>">  
                                <div class="dicustom-checkbox__label">
                                    <?php echo $i; ?>
                                </div>
                            </label>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dicustom-checkbox">
                            ...
                            <?php foreach ($finishings as $finishing) : ?>
                                <label class="dropdown-item">
                                    <input type="checkbox" name="ut_finishing[]" value="<?php echo esc_attr($finishing->name); ?>">  
                                    <div class="dicustom-checkbox__label">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dicustom-checkbox">
                        ...
                        <label class="dropdown-item">
                            <input type="checkbox" name="ut_typeMarket[]" value="Новостройки и вторичка">  
                            <div class="dicustom-checkbox__label">
                                Новостройки и вторичка
                            </div>
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="ut_typeMarket[]" value="Первичный">  
                            <div class="dicustom-checkbox__label">
                                Первичный
                            </div>
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="ut_typeMarket[]" value="Вторичный">  
                            <div class="dicustom-checkbox__label">
                                Вторичный
                            </div>
                        </label>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dicustom-checkbox">
                        ...
                        <label class="dropdown-item">
                            <input type="checkbox" name="ut_type[]" value="Апартаменты">  
                            <div class="dicustom-checkbox__label">
                                Апартаменты
                            </div>
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="ut_type[]" value="Арендный бизнес">  
                            <div class="dicustom-checkbox__label">
                                Арендный бизнес
                            </div>
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="ut_type[]" value="Дом">  
                            <div class="dicustom-checkbox__label">
                                Дом
                            </div>
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="ut_type[]" value="Квартира">  
                            <div class="dicustom-checkbox__label">
                                Квартира
                            </div>
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="ut_type[]" value="Лофт">  
                            <div class="dicustom-checkbox__label">
                                Лофт
                            </div>
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="ut_type[]" value="Машиноместо">  
                            <div class="dicustom-checkbox__label">
                                Машиноместо
                            </div>
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="ut_type[]" value="Особняк">  
                            <div class="dicustom-checkbox__label">
                                Особняк
                            </div>
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="ut_type[]" value="Пентхаус">  
                            <div class="dicustom-checkbox__label">
                                Пентхаус
                            </div>
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="ut_type[]" value="Помещение свободного назначения">  
                            <div class="dicustom-checkbox__label">
                                Помещение свободного назначения
                            </div>
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="ut_type[]" value="Пулл машиномест">  
                            <div class="dicustom-checkbox__label">
                                Пулл машиномест
                            </div>
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="ut_type[]" value="Резиденция">  
                            <div class="dicustom-checkbox__label">
                                Резиденция
                            </div>
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="ut_type[]" value="Таунхаус">  
                            <div class="dicustom-checkbox__label">
                                Таунхаус
                            </div>
                        </label>
            ...
            <div class="filter_row_btn">
                <button type="submit" class="btn_blue">Показать 0</button>
                <button type="button" class="btn clear">Сбросить</button>
            </div> 
        </div> 
    </div>
